<html>
	<head>
		<title>Recoger Libro</title>
		<meta charset="UTF-8"/>
		<link rel="stylesheet" href="stylesrecoger.css">
	</head>
	<body>
    <nav class="navbar">
    ...
    $consulta = $conexionlibros -> query("INSERT INTO libros(titulo,autor,genero,editorial,cantidad,fechapublicacion,edicion) 
                                VALUES ('$_REQUEST[titulo]','$_REQUEST[autor]','$_REQUEST[genero]',
                                '$_REQUEST[editorial]','$_REQUEST[cantidad]','$_REQUEST[fechapublicacion]','$_REQUEST[edicion]')");

    echo "<div class='libro'>
            <p>Libro Agregado, desea agregar otro libro?</p>
        </div>";
    ?>
    <a class="link2" id="boton" href="formulario.php">Agregar Otro Libro</a>
	<footer class="footer">
        <div class="waves">
